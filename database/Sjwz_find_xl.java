...
public class Sjwz_find_xl extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					Sjwz_find_xl frame = new Sjwz_find_xl();
	...
	private void refresh(){
		...
		Vector<Vector> ans=Sql_connetcton.wzFind(2,Login_infos.xlname,sd,ed);
	...
	public Sjwz_find_xl() {
		...
		label_4.setBounds(25, 15, 50, 15);
		contentPane.add(label_4);
		
		name1 = new JLabel("");
		name1.setBounds(50, 15, 80, 15);
