...
public class Sj_update_xl extends JFrame {
	...
	private void refresh(){
		Vector<Vector> ans=Sql_connetcton.getAllSj(3,Login_infos.xlname);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					Sj_update_xl frame = new Sj_update_xl();
	...
	public Sj_update_xl() {
		...
		label_3.setBounds(21, 38, 54, 15);
		contentPane.add(label_3);
		
		sjsex = new JComboBox();
		sjsex.setBounds(56, 35, 54, 21);
		sjsex.addItem("男");
		sjsex.addItem("女");
...
//								System.out.println(s.get(1));
		...
		setFocusTraversalPolicy(new FocusTraversalOnArray(new Component[]{sjnum, sjname, sjsex, button, button_2, textField_2, button_1, btnNewButton,table}));
	}
}
