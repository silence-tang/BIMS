...
public class Cl_update_xl extends JFrame {
	...
	private void refresh(){
		Vector<Vector> ans=Sql_connetcton.getAllCl(3,Login_infos.xlname);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					Cl_update_xl frame = new Cl_update_xl();
...
//								System.out.println(s.get(1));
		...
		setFocusTraversalPolicy(new FocusTraversalOnArray(new Component[]{cpnum, zwnum, button, button_2, textField_2, button_1, btnNewButton,table}));
	}
}
